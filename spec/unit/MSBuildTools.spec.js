...
describe('checkMSBuildVersion method', function(){
    ...
    beforeEach(function () {
        execOriginal = buildTools.__get__('utils.exec');
    });

    afterEach(function () {
        buildTools.__set__('utils.exec', execOriginal);
    });
...
describe('MSBuildTools object', function(){
    ...
    beforeEach(function () {
        spawnOriginal = buildTools.__get__('utils.spawn');
    });

    afterEach(function () {
        buildTools.__set__('utils.spawn', spawnOriginal);
    });
