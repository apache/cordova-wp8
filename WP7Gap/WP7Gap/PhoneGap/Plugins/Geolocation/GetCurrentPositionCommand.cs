//-----------------------------------------------------------------------
// <copyright file="GetCurrentPositionCommand.cs">
...
namespace PhoneGap.Plugins.Geolocation
{
    // TODO: check if can remove this and use built in browser location capabilities
    public class GetCurrentPositionCommand : PhoneGapCommand, IAsyncCommand
    {
